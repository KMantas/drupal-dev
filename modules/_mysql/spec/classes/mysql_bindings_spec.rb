...
describe 'mysql::bindings' do
  ...
  context 'Debian' do
    it_behaves_like 'bindings', 'Debian', 'Debian', 'libmysql-java', 'libdbd-mysql-perl', 'php-mysql', 'python-mysqldb', 'libmysql-ruby'
    it_behaves_like 'bindings', 'Debian', 'Ubuntu', 'libmysql-java', 'libdbd-mysql-perl', 'php-mysql', 'python-mysqldb', 'libmysql-ruby'
  end

  context 'freebsd' do
    it_behaves_like 'bindings', 'FreeBSD', 'FreeBSD', 'databases/mysql-connector-java', 'p5-DBD-mysql', 'databases/php-mysql', 'databases/py-MySQLdb', 'databases/ruby-mysql'
  end
